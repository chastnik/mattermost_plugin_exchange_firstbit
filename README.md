...
1. Скачайте последнюю версию плагина: [`releases/com.mattermost.exchange-plugin-1.3.3.tar.gz`](releases/com.mattermost.exchange-plugin-1.3.3.tar.gz)
...
- **[v1.3.3](releases/com.mattermost.exchange-plugin-1.3.3.tar.gz)** (22MB) - **РЕКОМЕНДУЕМАЯ** (для Mattermost 9.x+, российские серверы)
- **[v1.3.2](releases/com.mattermost.exchange-plugin-1.3.2.tar.gz)** (22MB) - (для Mattermost 9.x+, российские серверы)
- **[v1.3.1](releases/com.mattermost.exchange-plugin-1.3.1.tar.gz)** (22MB) - (для Mattermost 9.x+, российские серверы)
- **[v1.2.1](releases/com.mattermost.exchange-plugin-1.2.1.tar.gz)** (21MB) - Предыдущая стабильная версия
...
- 🎯 **Полная совместимость с российскими серверами** - поддержка устаревших версий Exchange
...
- 🎯 **Полная стабильность для российских серверов** - все команды теперь работают без ошибок таймаута

### v1.3.1 (2025-01-15)
- 🚨 **КРИТИЧЕСКОЕ ИСПРАВЛЕНИЕ HTTP 440 Login Timeout** - исправлена ошибка при сохранении настроек
- ⚡ **Оптимизирован процесс сохранения** - использование TestConnection вместо полного SOAP запроса  
- 🔄 **Автоматический повтор при таймауте** - плагин автоматически повторяет запрос при HTTP 440
- 🌐 **Отключены keep-alive соединения** - каждый запрос использует свежее соединение
- 📊 **Улучшенное логирование** - подробные логи ошибок для диагностики
- 🎯 **Протестировано с mail.1cbit.ru** - полностью исправлена работа с российскими серверами

### v1.3.0 (2025-07-04)
- 🚀 **КРИТИЧЕСКИЕ ИСПРАВЛЕНИЯ для российских Exchange серверов**
- ✅ **Специальная поддержка серверов типа 1cbit.ru** - протестировано и работает
- 🔧 **Правильное определение EWS путей** - автоматическое обнаружение `/owa/EWS/Exchange.asmx`
- 🌐 **Улучшенная аутентификация** - поддержка доменов `pbr`, множественные форматы пользователей
- 🔐 **Расширенная TLS поддержка** - совместимость с TLS 1.0-1.3 для устаревших серверов
- ⏱️ **Увеличенные таймауты** - до 45 секунд для медленных соединений
- 📊 **Подробная диагностика** - улучшенные сообщения об ошибках подключения
- ⚡ **Автоматическое обнаружение endpoint'ов** - плагин сам найдет рабочий путь EWS
