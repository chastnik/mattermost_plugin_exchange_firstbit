...
1. Скачайте последнюю версию плагина: [`releases/com.mattermost.exchange-plugin-1.1.0.tar.gz`](releases/com.mattermost.exchange-plugin-1.1.0.tar.gz)
...
- **[v1.1.0](releases/com.mattermost.exchange-plugin-1.1.0.tar.gz)** (21MB) - **РЕКОМЕНДУЕМАЯ** (исправлена проблема с веб-интерфейсом)
...
- 📦 Обновлен размер webpack bundle (12KB вместо 33 байт)
