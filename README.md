...
1. Скачайте последнюю версию плагина: [`releases/com.mattermost.exchange-plugin-1.3.2.tar.gz`](releases/com.mattermost.exchange-plugin-1.3.2.tar.gz)
...
- **[v1.3.2](releases/com.mattermost.exchange-plugin-1.3.2.tar.gz)** (22MB) - **РЕКОМЕНДУЕМАЯ** (для Mattermost 9.x+, российские серверы)
