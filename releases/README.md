...
### v1.3.0 (2025-01-15) - **РЕКОМЕНДУЕМАЯ**
**Файл:** `com.mattermost.exchange-plugin-1.3.0.tar.gz` (22MB)
...
- ✅ **Увеличенные таймауты** - до 45 секунд для медленных соединений
...
> **Важно:** Для Mattermost 6.x-8.x используйте v1.1.0. Для Mattermost 9.x+ используйте v1.3.0.
> **Для российских серверов Exchange обязательно используйте v1.3.0!**
...
### С любой предыдущей версии на v1.3.0 (рекомендуется для всех)

1. **Отключите** текущую версию плагина в System Console → Plugins
2. **Скачайте и установите** v1.3.0
