...
### v1.3.1 (2025-01-15) - **РЕКОМЕНДУЕМАЯ**
...
> **Важно:** Для Mattermost 6.x-8.x используйте v1.1.0. Для Mattermost 9.x+ используйте v1.3.1.
> **Для российских серверов Exchange обязательно используйте v1.3.1!**
...
### С любой предыдущей версии на v1.3.1 (рекомендуется для всех)

1. **Отключите** текущую версию плагина в System Console → Plugins
2. **Скачайте и установите** v1.3.1
